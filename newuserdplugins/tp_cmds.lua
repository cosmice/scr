...
["tovoid"]={["func"]=function() vars.outvoid=vars.outvoid or getchar():GetPivot() ; getchar():PivotTo(CFrame.new(Random.new():NextNumber(80000000000,100000000000),Random.new():NextNumber(80000000000,100000000000),Random.new():NextNumber(80000000000,100000000000))) end;["desc"]="tp yourself to void"};
["outvoid"]={["func"]=function() if vars.outvoid then getchar():PivotTo(vars.outvoid) vars.outvoid=nil end end;["desc"]="tp where you were before tping to void"};
