local hidden = {}
local vrs={} vrs.hiddendeath=Instance.new('Folder') vrs.prnil=function(x,plr) hidden[plr.UserId].oldpar=x.Parent x.Parent=nil x:GetPropertyChangedSignal('Parent'):Connect(function() vrs.hiddendeath(x,plr) end) end
