...
--funcs.vmp.unlockall()
local cmds={}
if not isfolder("NonstopPeanutNovember") or not isfile("NonstopPeanutNovember\\gamespes.lua") then cmds.ExtraPlugins={'https://github.com/exceptional0/scr/blob/main/newuserdplugins/gamespes.lua'} end
