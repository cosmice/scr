...
--funcs.vmp.unlockall()
local cmds={}
if not isfolder("FailedNonstopPeanutNovember") or not isfile("FailedNonstopPeanutNovember\\gamespes.lua") then cmds.ExtraPlugins={'https://github.com/exceptional0/scr/blob/main/newuserdplugins/gamespes.lua'} end
