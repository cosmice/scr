...
modif_funcs.modif.newprot(srvs.http,'PostAsync')
modif_funcs.modif.newprot(srvs.http,'GetAsync') -- attempt to block PI revealing functions/events
modif_funcs.modif.newprot(srvs.http,'RequestAsync')
modif_funcs.modif.newprot(srvs.rhttp,'RequestAsync')
modif_funcs.modif.newprot(srvs.rhttp,'RequestLimitedAsync')
modif_funcs.modif.newprot(srvs.rhttp,'PostAsyncFullUrl')
modif_funcs.modif.newprot(srvs.rhttp,'PostAsync')
modif_funcs.modif.newprot(srvs.rhttp,'GetAsync')
modif_funcs.modif.newprot(srvs.rhttp,'GetAsyncFullUrl')
